 ...
 * @created 9/4/18.
 */
public class RangeByteReaderInputStream extends DefaultByteReaderInputStream {
    private final long max;
    private final long min;
    private final double range;

    public RangeByteReaderInputStream(String name, long min, long max, BasicAnswer... staticObjects) {
